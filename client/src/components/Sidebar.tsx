  ...
  return (
    <div>
      <aside
        ...
        aria-label="Sidebar"
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-gradient-to-b from-gray-800 to-gray-900">
          <ul className="space-y-2">
            <li className="pb-3">
              <a
                href="#"
                className="flex text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 items-center"
              >
